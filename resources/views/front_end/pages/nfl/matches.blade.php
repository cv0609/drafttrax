...
<section class="fusball_leagues matches">
    <div class="container">
                    ...
                    <table id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Match Information</th>
                                <th scope="col">Team</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach ($matches as $key => $match)
                            ...
                            <tr class="matche-main" data-fixture-id="{{ $match->id }}">
                                <td class="match-team-logo">
                                    ...
                                    <img src="{{ $match->home_team_logo }}" class="lazy-load" data-src="{{ $match->home_team_logo }}" alt="team-logo-3">
                                ...
                                <td class="match-team-logo">
                                    <div class="match-team-inner">
                                        ...
                                        <img src="{{ $match->away_team_logo }}" class="lazy-load" data-src="{{ $match->away_team_logo }}" alt="team-logo-2">
